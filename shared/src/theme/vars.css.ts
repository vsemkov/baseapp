...
export const [themeLight, vars] = createTheme({
  ...
  colors: {
    ...
    languageSwitchText: colors.luckyPoint,
    languageSwitchTextHover: colors.luckyPoint,
...
export const themeDark = createTheme(vars, {
  ...
  colors: {
    ...
    languageSwitchText: colors.silverChalice,
    languageSwitchTextHover: colors.gray,
